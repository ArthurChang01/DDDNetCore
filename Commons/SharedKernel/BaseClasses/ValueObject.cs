...
namespace SharedKernel.BaseClasses
{
    public abstract class ValueObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            while (thisValues.MoveNext() && otherValue.MoveNext())
            {
                if (thisValues.Current is null ^
                    otherValue.Current is null)
                    return false;

                if (thisValues.Current != null &&
                    !thisValues.Current.Equals(otherValue.Current))
                    return false;
            }
            return !thisValues.MoveNext() && !otherValue.MoveNext();
        }
